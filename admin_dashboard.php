   ...
   <aside class="w-64 bg-white shadow-xl flex flex-col transition-all duration-300 z-20 hidden md:flex" id="sidebar">
    ...
    <div class="p-6 border-b border-gray-100 flex items-center justify-between">
        ...
        <div class="flex-1 py-4 overflow-y-auto">
            <nav class="space-y-1">
                ...
                <a href="#" onclick="showSection('riwayat', this)" class="sidebar-menu flex items-center justify-between px-6 py-3 text-gray-600 hover:bg-blue-50 hover:text-primary transition-colors">
                    ...
                    <div id="sidebar-booking-count" class="bg-primary text-white text-xs font-semibold px-2.5 py-1 rounded-full shadow-sm">
                        0
                    </div>
                </a>
    ...
    <script>
        ...
        function getStatusBadge(status) {
            ...
            if (status === 'pending') {
                return `<span class="px-3 py-1 bg-yellow-100 text-yellow-700 text-xs font-semibold rounded-full">Pending</span>`;
            }

            if (status === 'disetujui') {
                return `<span class="px-3 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full">Disetujui</span>`;
            }

            if (status === 'ditolak') {
                return `<span class="px-3 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded-full">Ditolak</span>`;
            }
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <button onclick="updateStatus(${b.id}, 'disetujui')" class="bg-primary hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors shadow-sm">
                                            Approve
                                        </button>

                                        <button onclick="updateStatus(${b.id}, 'ditolak')" class="bg-secondary hover:bg-orange-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors shadow-sm">
                                            Reject
                                        </button>
        ...
        async function loadAllBookings() {
            ...
            try {
                ...
                if (json.status === 'success') {
                    ...
                    document.getElementById('sidebar-booking-count').innerText = json.data.length;
                }
